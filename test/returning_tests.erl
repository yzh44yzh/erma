...
returning1_test() ->
    ...
    Q6 = <<"INSERT INTO users VALUES (1, 'Bob', 'Dou', 65), (6, 'Bill', 'Foo', 31) ",
           "RETURNING id">>,
    I6 = {insert, {table, "users"},
          {rows, [], [[1, "Bob", "Dou", 65], [6, "Bill", "Foo", 31]]},
          {returning, id}},
